...
func (m *MinIOReconciler) ProvisionS3() error {
...
func (m *MinIOReconciler) ProvisionAzure() (*lcm.CRStatus, error) {
...
func (m *MinIOReconciler) ProvisionGcs() (*lcm.CRStatus, error) {
	//mcsSecret := m.generateMcsSecret()
	//credsSecret := m.generateCredsSecret()
...
func (m *MinIOReconciler) ProvisionSwift() (*lcm.CRStatus, error) {
	//mcsSecret := m.generateMcsSecret()
	//credsSecret := m.generateCredsSecret()
...
func (m *MinIOReconciler) ProvisionOss() (*lcm.CRStatus, error) {
	//mcsSecret := m.generateMcsSecret()
	//credsSecret := m.generateCredsSecret()
